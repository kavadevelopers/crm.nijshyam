...
<head>
    <title>{{ CommonHelper::setting('app_name') }} | Admin Login</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ url('themes/admin/bower_components/bootstrap/css/bootstrap.min.css') }}">
    <!-- themify-icons line icon -->
    <link rel="stylesheet" type="text/css" href="{{ url('themes/admin/assets/icon/themify-icons/themify-icons.css') }}">
    <!-- ico font -->
    <link rel="stylesheet" type="text/css"
        href="{{ url('themes/admin/assets/icon/font-awesome/css/font-awesome.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ url('themes/admin/bower_components/pnotify/css/pnotify.brighttheme.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('themes/admin/bower_components/pnotify/css/pnotify.buttons.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('themes/admin/bower_components/pnotify/css/pnotify.history.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ url('themes/admin/bower_components/pnotify/css/pnotify.mobile.css') }}">
</head>
...
<body class="fix-menu">
                            ...
                            <div class="card-block">
                                <div class="row m-b-20">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="alert alert-danger icons-alert"
                                            style="margin-bottom: 0px; display: none;" id="error">
                                            <button type="button" class="close" data-dismiss="alert"
                                                aria-label="Close" style="margin-top: 9px;">
                                        ...
                                        <div class="alert alert-success icons-alert"
                                            style="margin-bottom: 0px; display: none;" id="success">
                                            <button type="button" class="close" data-dismiss="alert"
                                                aria-label="Close" style="margin-top: 9px;">
                                                <i class="icofont icofont-close-line-circled"></i>
                                            </button>
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" name="username" id="user" class="form-control"
                                        placeholder="User Name" autocomplete="off" required autofocus>
                                </div>
                                <div class="form-group form-primary">
                                ...
                                <div class="row m-t-25">
                                    <div class="col-12">
                                        ...
                                        <div class="forgot-phone text-right f-right">
                                            <a href="{{ url(CommonHelper::admin('forget-password')) }}"
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit"
                                            ...
                                            style="font-size: 18px" id="sign-in-button">
                ...
                $.ajax({
                    ...
                    success: function(out) {
                        if (out[0] == '0') {
                            ...
                            $("#success").show();
                            $("#sign-in-loader").html(
                                '<i class="fa fa-circle-o-notch fa-spin"></i> Redirecting...'
                                );
                            setTimeout(function() {
                                window.location =
                                    "<?= url(CommonHelper::admin('dashboard')) ?>";
                            }, 1000);
                        } else {
    ...
    <script type="text/javascript"
        src="{{ url('themes/admin/bower_components/jquery-slimscroll/js/jquery.slimscroll.js') }}"></script>
    <!-- modernizr js -->
    <script type="text/javascript" src="{{ url('themes/admin/bower_components/modernizr/js/modernizr.js') }}"></script>
    <script type="text/javascript" src="{{ url('themes/admin/bower_components/modernizr/js/css-scrollbars.js') }}">
    </script>
    <!-- i18next.min.js -->
    ...
    <script type="text/javascript" src="{{ url('themes/admin/bower_components/pnotify/js/pnotify.callbacks.js') }}">
    </script>
    ...
    <script type="text/javascript" src="{{ url('themes/admin/bower_components/pnotify/js/pnotify.nonblock.js') }}">
    </script>
    <script type="text/javascript" src="{{ url('themes/admin/bower_components/sweetalert/js/sweetalert.min.js') }}">
    </script>
</body>
